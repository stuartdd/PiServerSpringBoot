...
(function dartProgram() {
  ...
  F = {
    ...
    selectThumbnailImage: function(encName, dispName) {
      ...
      J.set$innerHtml$x($.$get$originalImage(), '<img id="oriiginalImage" width="100%" title="' + H.S(dispName) + '"src="/files/user/' + H.S($.currentUserId) + "/loc/thumbs/path/" + H.S(encPath) + "/name/" + H.S(encName) + '">');
